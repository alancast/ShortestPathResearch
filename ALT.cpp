...
void get_dist_btw_landmarks(std::vector<std::pair<int,int> > &graph_coords,
    std::set<int> &landmarks, std::vector<std::vector<std::pair<int, double> > >  &land_dist);

void print_land_mark_distances(std::vector<std::vector<std::pair<int, double> > >  &land_dist);
...
int main(int argc, char** argv){
    ...
    std::set<int> landmarks;
    std::vector<std::vector<std::pair<int, double> > >  land_dist;
    ...
    // get_landmarks(8, graph_coords, landmarks);

    // print_landmarks(landmarks);

    // get_dist_btw_landmarks(graph_coords, landmarks, land_dist);

    // print_land_mark_distances(land_dist);
